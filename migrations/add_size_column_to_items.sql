-- ============================================
-- Add size Column to Items Table
-- La Verdad Uniform Ordering System
-- ============================================
-- This migration adds a size column to the items table
...
CREATE INDEX IF NOT EXISTS idx_items_name_education_size 
ON items(name, education_level, size);

-- Add comment to document the column
COMMENT ON COLUMN items.size IS 'Size of the item (XS, S, M, L, XL, XXL, or N/A for non-sized items)';
